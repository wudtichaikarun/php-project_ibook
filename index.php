...
//find way to change color favorit-icon
 // var chkRedfavorite = $(".col-md-2").find('div.slider').attr('chkFavorite', 'Yes');
 // console.log(chkRedfavorite);
 // if (chkRedfavorite == true){
 //   $(this).attr('slider', 'slider-delete');
 // }
  //delete book
  $(".delete-icon").click(function(){

     var askUser = confirm("Do you want to delete this book right?");
     if(askUser == true){
       var href = $(this).parent().find('.a_del_book').attr('href');
...
<ul class="category_menu">
  ...
  <li><a href='language.php'>Langyae</a></li>
  ...
  <div class="container">
    ...
    echo "<div class='col-md-2 index'>";
          ...
          //favorite
            ...
            //delete
            echo "<label class='switch2' style='display:none'>";
