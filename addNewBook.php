...
<!-- </form> -->
    ...
    <!-- <div class="form-row bookfile">
      <label for="c5">Book file :</label> -->
      <!-- <input type="text"  id="c5" name="series_name" placeholder="Book serice name"> -->
      <!-- <input type="input-file"  id='c5' name="book_file" >
    </div> -->
...
<!-- series_name -->
    <!-- <p>ignore if don't have serice:</p> -->
   <div class="form-row">
